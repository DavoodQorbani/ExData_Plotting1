...
hist(desired_rows$Global_active_power, col = "red", bg = "transparent",
     main = "Global Active Power", xlab = "Global Active Power (kilowatts)", cex = 0.4)

dev.copy(png, file = "./exdata-016/Course Project 1/plot1.png",
...
print("You can find the result of this R script (plot1.png) in the above mentioned folder.")

...
png(file = "./exdata-016/Course Project 1/plot4.png",
...
# Plot 4.2
plot(desired_rows$Date.Time, desired_rows$Sub_metering_1,
     type="n", xlab ="", ylab = "Energy sub metering", cex = 0.6)
points(desired_rows$Date.Time, desired_rows$Sub_metering_1, type="l", col = "black")
points(desired_rows$Date.Time, desired_rows$Sub_metering_2, type="l", col = "red")
points(desired_rows$Date.Time, desired_rows$Sub_metering_3, type="l", col = "blue")
...
# Plot 4.3
plot(desired_rows$Date.Time, desired_rows$Voltage,
     type="l", xlab ="DateTime", ylab = "Voltage", cex = 0.6)


# Plot 4.4
plot(desired_rows$Date.Time, desired_rows$Global_reactive_power,
     type="l", xlab ="DateTime", ylab = "Global Reactive Power", cex = 0.6)
...
print("You can find the result of this R script (plot4.png) in the above mentioned folder.")
